...
export function createApp(): express.Express {
  ...
  const exportService = createExportService(userService, trackingService, recipeService);
  ...
  app.get('/health', (_req, res) => {
    res.json({ ok: true, name: 'tang-server' });
  });
  ...
  app.use('/api/ai', createAIConfigRouter(aiConfigService, requireAuth));
